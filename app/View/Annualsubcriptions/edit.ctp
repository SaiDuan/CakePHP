...
<?php echo $this->Form->create('Annualsubcription');?>
	<fieldset>
		<legend><?php echo __('Edit Annualsubcription'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Annualsubcription.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Annualsubcription.id'))); ?></li>
