<div class="partyfacilitydiscos view">
<h2><?php  echo __('Partyfacilitydisco');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($partyfacilitydisco['Partyfacilitydisco']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Disco Description'); ?></dt>
		<dd>
			<?php echo h($partyfacilitydisco['Partyfacilitydisco']['disco_description']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Partyfacilitydisco'), array('action' => 'edit', $partyfacilitydisco['Partyfacilitydisco']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Partyfacilitydisco'), array('action' => 'delete', $partyfacilitydisco['Partyfacilitydisco']['id']), null, __('Are you sure you want to delete # %s?', $partyfacilitydisco['Partyfacilitydisco']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($partyfacilitydisco['Hall'])):?>
	...
	<?php
		$i = 0;
		foreach ($partyfacilitydisco['Hall'] as $hall): ?>
		<tr>
