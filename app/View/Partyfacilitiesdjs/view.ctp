<div class="partyfacilitiesdjs view">
<h2><?php  echo __('Partyfacilitiesdj');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($partyfacilitiesdj['Partyfacilitiesdj']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Dj Descriptions'); ?></dt>
		<dd>
			<?php echo h($partyfacilitiesdj['Partyfacilitiesdj']['dj_descriptions']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Partyfacilitiesdj'), array('action' => 'edit', $partyfacilitiesdj['Partyfacilitiesdj']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Partyfacilitiesdj'), array('action' => 'delete', $partyfacilitiesdj['Partyfacilitiesdj']['id']), null, __('Are you sure you want to delete # %s?', $partyfacilitiesdj['Partyfacilitiesdj']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($partyfacilitiesdj['Hall'])):?>
	...
	<?php
		$i = 0;
		foreach ($partyfacilitiesdj['Hall'] as $hall): ?>
		<tr>
