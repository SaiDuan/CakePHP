...
<?php echo $this->Form->create('Partyfacilitiesdj');?>
	<fieldset>
		<legend><?php echo __('Edit Partyfacilitiesdj'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Partyfacilitiesdj.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Partyfacilitiesdj.id'))); ?></li>
