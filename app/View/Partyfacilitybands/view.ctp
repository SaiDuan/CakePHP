<div class="partyfacilitybands view">
<h2><?php  echo __('Partyfacilityband');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($partyfacilityband['Partyfacilityband']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Band Description'); ?></dt>
		<dd>
			<?php echo h($partyfacilityband['Partyfacilityband']['band_description']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Partyfacilityband'), array('action' => 'edit', $partyfacilityband['Partyfacilityband']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Partyfacilityband'), array('action' => 'delete', $partyfacilityband['Partyfacilityband']['id']), null, __('Are you sure you want to delete # %s?', $partyfacilityband['Partyfacilityband']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($partyfacilityband['Hall'])):?>
	...
	<?php
		$i = 0;
		foreach ($partyfacilityband['Hall'] as $hall): ?>
		<tr>
