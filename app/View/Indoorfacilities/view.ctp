<div class="indoorfacilities view">
<h2><?php  echo __('Indoorfacility');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($indoorfacility['Indoorfacility']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Indoor Facilities Name'); ?></dt>
		<dd>
			<?php echo h($indoorfacility['Indoorfacility']['indoor_facilities_name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Indoorfacility'), array('action' => 'edit', $indoorfacility['Indoorfacility']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Indoorfacility'), array('action' => 'delete', $indoorfacility['Indoorfacility']['id']), null, __('Are you sure you want to delete # %s?', $indoorfacility['Indoorfacility']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($indoorfacility['Hall'])):?>
	...
	<?php
		$i = 0;
		foreach ($indoorfacility['Hall'] as $hall): ?>
		<tr>
