<div class="subtypes index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('hallsowner_type');?></th>
			<th><?php echo $this->Paginator->sort('type_limitation');?></th>
	...
	<tr>
		...
		<td><?php echo h($subtype['Subtype']['hallsowner_type']); ?>&nbsp;</td>
		<td><?php echo h($subtype['Subtype']['type_limitation']); ?>&nbsp;</td>
		<td><?php echo h($subtype['Subtype']['price']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $subtype['Subtype']['id']), null, __('Are you sure you want to delete # %s?', $subtype['Subtype']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
