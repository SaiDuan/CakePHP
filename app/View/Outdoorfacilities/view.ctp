<div class="outdoorfacilities view">
<h2><?php  echo __('Outdoorfacility');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($outdoorfacility['Outdoorfacility']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Outdoor Facilities Name'); ?></dt>
		<dd>
			<?php echo h($outdoorfacility['Outdoorfacility']['outdoor_facilities_name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Outdoorfacility'), array('action' => 'edit', $outdoorfacility['Outdoorfacility']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Outdoorfacility'), array('action' => 'delete', $outdoorfacility['Outdoorfacility']['id']), null, __('Are you sure you want to delete # %s?', $outdoorfacility['Outdoorfacility']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($outdoorfacility['Hall'])):?>
	...
	<?php
		$i = 0;
		foreach ($outdoorfacility['Hall'] as $hall): ?>
		<tr>
