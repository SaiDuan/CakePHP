<div class="suitabilities view">
<h2><?php  echo __('Suitability');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($suitability['Suitability']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Suitabilities Name'); ?></dt>
		<dd>
			<?php echo h($suitability['Suitability']['suitabilities_name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Suitability'), array('action' => 'edit', $suitability['Suitability']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Suitability'), array('action' => 'delete', $suitability['Suitability']['id']), null, __('Are you sure you want to delete # %s?', $suitability['Suitability']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($suitability['Hall'] as $hall): ?>
		<tr>
