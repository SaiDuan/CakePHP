<div class="restrictionevents view">
<h2><?php  echo __('Restrictionevent');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($restrictionevent['Restrictionevent']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Event Description'); ?></dt>
		<dd>
			<?php echo h($restrictionevent['Restrictionevent']['event_description']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Restrictionevent'), array('action' => 'edit', $restrictionevent['Restrictionevent']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Restrictionevent'), array('action' => 'delete', $restrictionevent['Restrictionevent']['id']), null, __('Are you sure you want to delete # %s?', $restrictionevent['Restrictionevent']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($restrictionevent['Hall'])):?>
	...
	<?php
		$i = 0;
		foreach ($restrictionevent['Hall'] as $hall): ?>
		<tr>
