<div class="restrictionsmokings view">
<h2><?php  echo __('Restrictionsmoking');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($restrictionsmoking['Restrictionsmoking']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Smoking Description'); ?></dt>
		<dd>
			<?php echo h($restrictionsmoking['Restrictionsmoking']['smoking_description']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Restrictionsmoking'), array('action' => 'edit', $restrictionsmoking['Restrictionsmoking']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Restrictionsmoking'), array('action' => 'delete', $restrictionsmoking['Restrictionsmoking']['id']), null, __('Are you sure you want to delete # %s?', $restrictionsmoking['Restrictionsmoking']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($restrictionsmoking['Hall'])):?>
	...
	<?php
		$i = 0;
		foreach ($restrictionsmoking['Hall'] as $hall): ?>
		<tr>
