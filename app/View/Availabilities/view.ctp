...
<h2><?php  echo __('Availability');?></h2>
	<dl>
		...
		<dd>
			<?php echo h($availability['Availability']['day']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('From Time'); ?></dt>
		<dd>
			<?php echo h($availability['Availability']['from_time']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('To Time'); ?></dt>
		<dd>
			<?php echo h($availability['Availability']['to_time']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Availability'), array('action' => 'delete', $availability['Availability']['id']), null, __('Are you sure you want to delete # %s?', $availability['Availability']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($availability['Hall'])):?>
	...
	<?php
		$i = 0;
		foreach ($availability['Hall'] as $hall): ?>
		<tr>
