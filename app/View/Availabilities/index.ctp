<div class="availabilities index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('from_time');?></th>
			<th><?php echo $this->Paginator->sort('to_time');?></th>
	...
	<tr>
		...
		<td><?php echo h($availability['Availability']['day']); ?>&nbsp;</td>
		<td><?php echo h($availability['Availability']['from_time']); ?>&nbsp;</td>
		<td><?php echo h($availability['Availability']['to_time']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $availability['Availability']['id']), null, __('Are you sure you want to delete # %s?', $availability['Availability']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
