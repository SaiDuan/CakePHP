<div class="restrictionminors view">
<h2><?php  echo __('Restrictionminor');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($restrictionminor['Restrictionminor']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Minor Description'); ?></dt>
		<dd>
			<?php echo h($restrictionminor['Restrictionminor']['minor_description']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Restrictionminor'), array('action' => 'edit', $restrictionminor['Restrictionminor']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Restrictionminor'), array('action' => 'delete', $restrictionminor['Restrictionminor']['id']), null, __('Are you sure you want to delete # %s?', $restrictionminor['Restrictionminor']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Restrictionminors'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Restrictionminor'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($restrictionminor['Hall'])):?>
	...
	<?php
		$i = 0;
		foreach ($restrictionminor['Hall'] as $hall): ?>
		<tr>
