<div class="restrictionnoises view">
<h2><?php  echo __('Restrictionnoise');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($restrictionnoise['Restrictionnoise']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Noise Description'); ?></dt>
		<dd>
			<?php echo h($restrictionnoise['Restrictionnoise']['noise_description']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Restrictionnoise'), array('action' => 'edit', $restrictionnoise['Restrictionnoise']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Restrictionnoise'), array('action' => 'delete', $restrictionnoise['Restrictionnoise']['id']), null, __('Are you sure you want to delete # %s?', $restrictionnoise['Restrictionnoise']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($restrictionnoise['Hall'])):?>
	...
	<?php
		$i = 0;
		foreach ($restrictionnoise['Hall'] as $hall): ?>
		<tr>
