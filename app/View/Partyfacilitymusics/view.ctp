<div class="partyfacilitymusics view">
<h2><?php  echo __('Partyfacilitymusic');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($partyfacilitymusic['Partyfacilitymusic']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Music Description'); ?></dt>
		<dd>
			<?php echo h($partyfacilitymusic['Partyfacilitymusic']['music_description']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Partyfacilitymusic'), array('action' => 'edit', $partyfacilitymusic['Partyfacilitymusic']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Partyfacilitymusic'), array('action' => 'delete', $partyfacilitymusic['Partyfacilitymusic']['id']), null, __('Are you sure you want to delete # %s?', $partyfacilitymusic['Partyfacilitymusic']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($partyfacilitymusic['Hall'])):?>
	...
	<?php
		$i = 0;
		foreach ($partyfacilitymusic['Hall'] as $hall): ?>
		<tr>
