<div class="featurecateringrestrictions view">
<h2><?php  echo __('Featurecateringrestriction');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($featurecateringrestriction['Featurecateringrestriction']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Cateringrestriction Description'); ?></dt>
		<dd>
			<?php echo h($featurecateringrestriction['Featurecateringrestriction']['cateringrestriction_description']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Featurecateringrestriction'), array('action' => 'edit', $featurecateringrestriction['Featurecateringrestriction']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Featurecateringrestriction'), array('action' => 'delete', $featurecateringrestriction['Featurecateringrestriction']['id']), null, __('Are you sure you want to delete # %s?', $featurecateringrestriction['Featurecateringrestriction']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($featurecateringrestriction['Hall'])):?>
	...
	<?php
		$i = 0;
		foreach ($featurecateringrestriction['Hall'] as $hall): ?>
		<tr>
