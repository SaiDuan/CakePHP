<div class="pricings view">
<h2><?php  echo __('Pricing');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($pricing['Pricing']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Price Name'); ?></dt>
		<dd>
			<?php echo h($pricing['Pricing']['price_name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Price/fee'); ?></dt>
		<dd>
			<?php echo h($pricing['Pricing']['price/fee']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Pricing'), array('action' => 'edit', $pricing['Pricing']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Pricing'), array('action' => 'delete', $pricing['Pricing']['id']), null, __('Are you sure you want to delete # %s?', $pricing['Pricing']['id'])); ?> </li>
