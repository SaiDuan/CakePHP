<div class="technicalFacilities view">
<h2><?php  echo __('Technical Facility');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($technicalFacility['TechnicalFacility']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Technical Facilities Name'); ?></dt>
		<dd>
			<?php echo h($technicalFacility['TechnicalFacility']['technical_facilities_name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Technical Facility'), array('action' => 'edit', $technicalFacility['TechnicalFacility']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Technical Facility'), array('action' => 'delete', $technicalFacility['TechnicalFacility']['id']), null, __('Are you sure you want to delete # %s?', $technicalFacility['TechnicalFacility']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($technicalFacility['Hall'])):?>
	...
	<?php
		$i = 0;
		foreach ($technicalFacility['Hall'] as $hall): ?>
		<tr>
