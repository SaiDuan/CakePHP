<div class="restrictiondecorations view">
<h2><?php  echo __('Restrictiondecoration');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($restrictiondecoration['Restrictiondecoration']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Decoration Description'); ?></dt>
		<dd>
			<?php echo h($restrictiondecoration['Restrictiondecoration']['decoration_description']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Restrictiondecoration'), array('action' => 'edit', $restrictiondecoration['Restrictiondecoration']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Restrictiondecoration'), array('action' => 'delete', $restrictiondecoration['Restrictiondecoration']['id']), null, __('Are you sure you want to delete # %s?', $restrictiondecoration['Restrictiondecoration']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($restrictiondecoration['Hall'])):?>
	...
	<?php
		$i = 0;
		foreach ($restrictiondecoration['Hall'] as $hall): ?>
		<tr>
