<div class="featureparkings view">
<h2><?php  echo __('Featureparking');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($featureparking['Featureparking']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Featureparkings Desciption'); ?></dt>
		<dd>
			<?php echo h($featureparking['Featureparking']['featureparkings_desciption']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Featureparking'), array('action' => 'edit', $featureparking['Featureparking']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Featureparking'), array('action' => 'delete', $featureparking['Featureparking']['id']), null, __('Are you sure you want to delete # %s?', $featureparking['Featureparking']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($featureparking['Hall'])):?>
	...
	<?php
		$i = 0;
		foreach ($featureparking['Hall'] as $hall): ?>
		<tr>
