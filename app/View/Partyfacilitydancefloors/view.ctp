<div class="partyfacilitydancefloors view">
<h2><?php  echo __('Partyfacilitydancefloor');?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($partyfacilitydancefloor['Partyfacilitydancefloor']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Dance Floor Description'); ?></dt>
		<dd>
			<?php echo h($partyfacilitydancefloor['Partyfacilitydancefloor']['dance_floor_description']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Partyfacilitydancefloor'), array('action' => 'edit', $partyfacilitydancefloor['Partyfacilitydancefloor']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Partyfacilitydancefloor'), array('action' => 'delete', $partyfacilitydancefloor['Partyfacilitydancefloor']['id']), null, __('Are you sure you want to delete # %s?', $partyfacilitydancefloor['Partyfacilitydancefloor']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($partyfacilitydancefloor['Hall'])):?>
	...
	<?php
		$i = 0;
		foreach ($partyfacilitydancefloor['Hall'] as $hall): ?>
		<tr>
